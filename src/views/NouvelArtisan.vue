<template>
  <div class="">
    ...
    <form>
        ...
        <!-- <label for="thumbnail">Portrait de l'artisan : </label>
        <picture-input type="file" v-model="thumbnail" @change="onChange()" width="500" height="500" margin="16" accept="image/jpeg,image/png">
        </picture-input><br> -->
