<!-- <template lang="html">
  <div class="">
    ...
    <h2> Produits de cet artisan: </h2>
     ...
     <div class="products">
        <div class="products-div" v-for="product in produits" :key="product.id_product">
...
export default {
  ...
  mounted() {
    ...
    axios.get('http://localhost:3000/artisans').then(response => (this.artisans = response.data));
