...
app.post('/artisans/nouveau', (req, res) => {
    let sql =  `INSERT INTO artisans (name, presentation, thumbnail, photo, origine, firstPage, artisanDuMois) VALUES ('${req.body.name}', '${req.body.presentation}', '${req.body.thumbnail}', '${req.body.photo}', '${req.body.origine}', ${req.body.firstPage}, ${req.body.artisanDuMois} )`;
    db.query(sql, (err, results) => {
        if(err) throw err;
        res.status(200).send(results);
    })
